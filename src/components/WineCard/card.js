    ...
    <Paper elevation={0} style={{margin:10,padding:10}}>
      <Grid container direction="row">
        ...
        <Grid item xl={10} lg={10} md={10} sm={12} xs={12}>
              ...
              <Grid container direction="row">
                ...
                >
                  ...
                  >
                    ...
                    <Grid item xl={1} lg={11} md={11} sm={11} xs={11}>
                      {" "}
                      <Typography
                        variant="caption"
                        display="block"
                  ...
                  >
                    <Grid item xl={1} lg={1} md={1} sm={1} xs={1}>
                      ...
                      <Avatar
                        ...
                        src="https://upload.wikimedia.org/wikipedia/commons/thumb/8/88/Flag_of_Australia_%28converted%29.svg/1200px-Flag_of_Australia_%28converted%29.svg.png"
                        style={{
                          background: "yellow",height:25,width:25
                        }}
                      />
                    </Grid>
                    <Grid item xl={1} lg={11} md={11} sm={11} xs={11}>
          ...
          justify="center" xl={6} lg={6} md={6} sm={6} xs={6}>
                      {" "}
                      <Button  style={{
                          fontSize: 22,
                          fontWeight: 600,
                          padding: "3px 12px 3px 12px",
                          color: "white",  background: "#02A78B",
                         borderRadius:25,height:50,width:150
                        }}> $ {v.ratingCount}</Button>
                    </Grid>
                  </Grid>
                </Grid>
                <Grid
